    ...
    <div className="w-full px-2">
      ...
      <div className="hidden sm:block">
        <div className="relative flex items-center justify-between">
          ...
          <motion.div
            className="absolute top-5 left-5 h-1 rounded-full bg-gradient-to-r from-blue-500 to-violet-500"
            initial={{ width: "0%" }}
            animate={{
            ...
            return (
              <div key={step.key} className="relative z-10 flex flex-col items-center">
                ...
                >
                  {isCompleted ? (
                    <motion.div
                      className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-500 text-white shadow-lg"
                      initial={{ scale: 0.8 }}
                      animate={{ scale: 1 }}
                    >
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-500 text-white shadow-lg shadow-blue-500/30">
                        <motion.div
          ...
          return (
            <div key={step.key} className="flex items-start gap-3">
              <div className="flex flex-col items-center">
                ...
                >
                  {isCompleted ? (
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-500 text-white">
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-500 text-white">
                        <motion.div
                ...
                {!isLast && (
                  <div className={`w-0.5 h-8 ${
                    isCompleted ? "bg-gradient-to-b from-blue-500 to-violet-500" : "bg-slate-200 dark:bg-slate-700"
                  }`} />
                )}
              </div>
              <motion.span
    ...
    <div className="w-full px-2">
      <div className="hidden sm:block">
        <div className="relative flex items-center justify-between">
          <div className="absolute top-5 left-5 right-5 h-1 rounded-full bg-slate-200 dark:bg-slate-700" />
          <motion.div
            className="absolute top-5 left-5 h-1 rounded-full bg-gradient-to-r from-blue-500 to-red-500"
            initial={{ width: "0%" }}
            animate={{ width: "75%" }}
            transition={{ duration: 1.2, ease: "easeOut", delay: 0.3 }}
            style={{ maxWidth: "calc(100% - 40px)" }}
          ...
          <div key={step.key} className="flex items-start gap-3">
            <div className="flex flex-col items-center">
              <motion.div
                ...
                animate={{ scale: 1 }}
                transition={{ delay: 0.2 + index * 0.1, type: "spring" }}
                className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-500 text-white"
              >
                <Check className="h-4 w-4" strokeWidth={3} />
              </motion.div>
              <div className="w-0.5 h-8 bg-gradient-to-b from-blue-500 to-violet-500" />
            </div>
            <motion.span
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
